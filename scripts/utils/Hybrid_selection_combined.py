...
class CombinedHybridSelection:

    def __init__(self, coverageCSV: CSVLoader, simlarityCSV: CSVLoader, foundation = None, selectionPool = None, branch = False):
    ...
    def __firstSelection(self):
        ...
        # Remove it from the coverage matrix
        self.covmatrix.pop(maxKey)
